...
export default function Error() {
  return (
    <div className="bg-brand-beige-10 flex flex-col items-center justify-center h-screen" id="oopss">
      <div id="error-text" className="text-brand-orange-70 text-center">
