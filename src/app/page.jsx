  ...
  return (
    <main className="flex flex-col items-center justify-center h-screen">
      <div className="text-center px-4 py-10 mx-auto sm:w-3/4 lg:w-2/3 xl:w-2/5 sm:p-10 md:rounded">
        ...
        <h2 className="justify-center mx-auto text-xl font-normal leading-7 text-center  font-poppins">Submit an URL to take the first step towards creating a more accessible web?</h2>
      </div>

      <div className=" px-6  mx-auto sm:w-3/4 lg:w-2/3 xl:w-2/5 sm:px-14 py-7 rounded-xl shadow-glass-1 bg-white bg-opacity-20 ">
        <form action="/result" className=" gap-3 py-4 px-6 md:px-0 sm:py-10 flex flex-col sm:flex-row">
